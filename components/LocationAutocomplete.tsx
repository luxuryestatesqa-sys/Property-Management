...
// Suggests building/tower names already used within the given area +
// community, so agents typing a building they've entered before (or a
// colleague has) get it as a one-tap suggestion.
export default function LocationAutocomplete({ label, placeholder, value, onChange, area, community, disabled }: LocationAutocompleteProps) {
  ...
  useEffect(() => {
    if (disabled) return;
    const params = new URLSearchParams({ level: "building" });
